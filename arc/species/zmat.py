...
The isotopes list is not saved in the zmat, it exists in the xyz dic, and can be attained by the map in the zmat.
    ...
    for i in range(len(mol.atoms)):
        ...
        for atom1 in mol.atoms:
            ...
            for atom1 in mol.atoms:
                ...
                # try hydrogens (an atom might be constrain to H, in which case H should come before that atom)
                for atom1 in mol.atoms:
                    atom1_index = mol.atoms.index(atom1)
...
# todo: - analyze pf1010c 1e-8 (or 1e-6)
#       - write this function according to the notebook
#       - test '_atom' modifications
#       - develop '_group' modifications




# modify iPy notebooks: zdd a zmat conversion, plot xyz
# look at Duminda's crushed example, add to trsh?
# consolidate this and species.set_dihedral()
