...
class TestZMat(unittest.TestCase):
    ...
    def test_zmat_from_xyz(self):
        ...
        expected_z = {'symbols': ('C', 'H', 'H', 'H', 'H'),
                      ...
                      'vars': {'R_1_0': 1.0912484581271156, 'R_2_1': 1.7820012700068855,
                               'A_2_1_0': 35.26438764560717, 'R_3_2': 1.7820012700068855,
                               'A_3_2_0': 35.26438764560717, 'D_3_2_0_1': 120.00000000000001,
                               'R_4_3': 1.7820012700068855, 'A_4_3_2': 59.99999916833805,
                               'D_4_3_2_1': 70.52877936550931},
        ...
        expected_z = {'symbols': ('C', 'H', 'H', 'H', 'H'),
                      'coords': ((None, None, None),
                                 ('R_1_0', None, None),
                                 ('R_2|3|4_1|2|3', 'A_2|3_1|2_0|0', None),
