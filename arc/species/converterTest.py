...
O       2.17315400   -0.03069900   -0.09349100"""
    ...
    def test_center_xyz(self):
        """Test centering xyz"""
        xyz0 = 'C 1.22 1.00 5.54'

        self.assertEqual('C       0.00000000    0.00000000    0.00000000', converter.center_xyz(xyz0))

        xyz1 = """C  1.05  1.05  1.05
                  H -0.95 -0.95 -0.95"""

        xyz1_centered_expected = """C       1.00000000    1.00000000    1.00000000
H      -1.00000000   -1.00000000   -1.00000000"""

        self.assertEqual(xyz1_centered_expected, converter.center_xyz(xyz1))

        xyz2 = """N       0.70306453   -0.09642538   -0.07034507
N      -0.70306453    0.09642538   -0.07034507
H       1.14674162    0.77233195   -0.33522485
H       1.06264540   -0.38648461    0.83246906
H      -1.06264540    0.38648461    0.83246906
H      -1.14674162   -0.77233195   -0.33522485"""

        xyz2_centered_expected = """N       0.70306453   -0.09642538   -0.21264478
N      -0.70306453    0.09642538   -0.21264478
H       1.14674162    0.77233195   -0.47752456
H       1.06264540   -0.38648461    0.69016935
H      -1.06264540    0.38648461    0.69016935
H      -1.14674162   -0.77233195   -0.47752456"""

        self.assertEqual(xyz2_centered_expected, converter.center_xyz(xyz2))

        xyz3 = """C      -1.10575300    0.12082589   -0.25988500
C       0.15957600   -0.25108111    0.45924100
C       1.39738600    0.01269189    0.02990200
H      -0.89600200    0.64481389   -1.19777400
H      -1.73574400    0.76978789    0.36164400
H      -1.70350600   -0.76993011   -0.49136900
H       0.03478100   -0.77821511    1.40602000
H       2.27309100   -0.28456611    0.59956000
H       1.57617100    0.53567289   -0.90733900"""

        self.assertEqual(xyz3, converter.center_xyz(xyz3))  # already centered
