...
""")
    ...
    def test_modify_coords(self):
        ...
        indices, new_val = [5, 2, 1, 0], 270
        expected_xyz = {'symbols': ('O', 'C', 'C', 'S', 'O', 'C', 'C', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H'),
                        'isotopes': (16, 12, 12, 32, 16, 12, 12, 1, 1, 1, 1, 1, 1, 1, 1, 1),
                        'coords': ((-0.08154138342518401, -1.7345579044147796, -1.338126093198337),
                                   (-0.08154138342518401, -1.7345579044147796, -0.0006827034342433702),
                                   (-0.08154138342518401, -0.23068641158194247, 0.5106364784224058),
                                   (-1.7043598708202563, 0.5514632372212591, 0.1482090934978728),
                                   (0.9432839193209787, 0.45810491146078247, -0.2158395605361081),
                                   (1.358001665799169, 0.28980002946755246, 0.6876028631655533),
                                   (1.5591686370691908, 1.766368909916848, 0.3562766913959412),
                                   (0.7953274140121734, -2.199171108291611, 0.48104061279229615),
                                   (-0.9045191055678405, -2.238615021032233, 0.5320738164210825),
                                   (-1.7998872384657179, -0.07168517465161006, -1.0395532128522331),
                                   (0.9058117919119782, -0.0658334280467483, -1.0526303799783137),
                                   (2.018570104277827, -0.2730122892567415, 0.014784333176391495),
                                   (1.711873804728975, 0.09577412411481423, 1.7078250539094686),
                                   (1.0183576199994246, 2.417521039622391, 1.048702942701591),
                                   (1.2326282817315435, 1.995086390358216, -0.6628436703729652),
                                   (2.621734267529783, 2.0210202118965666, 0.4301755946865753))}
        new_xyz = converter.modify_coords(coords=xyz3, indices=indices, new_value=new_val,
                                          modification_type=modification_type, mol=mol3)
        self.assertTrue(almost_equal_coords_lists(new_xyz, expected_xyz))
        self.assertAlmostEqual(converter.get_zmat_param_value(coords=new_xyz, indices=indices, mol=mol3), new_val, 5)
