    ...
    H      -1.15029500    1.55122700    0.23360600""",
        ...
        species_dict = {'arkane_file': None, 'bond_corrections': {}, 'charge': 0,
                        ...
                        'successful_methods': ['autotst', 'autotst', 'autotst', 'autotst',
                                               ...
                                               'kinbot', 'kinbot'],
                        'ts_checks': {'E0': False, 'IRC': False, 'e_elect': True, 'freq': True, 'NMD': True, 'warnings': ''},
...
""")
    ...
    def test_rmg_mol_from_dict_repr(self):
        ...
        mol = rmg_mol_from_dict_repr(representation=representation, is_ts=False)
    ...
    def test_rmg_mol_to_dict_repr(self):
        ...
        for atom in mol.atoms:
            atom.id = -1
        representation = rmg_mol_to_dict_repr(mol, testing=True)
