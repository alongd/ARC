...
ts_adapters_by_rmg_family = {'1+2_Cycloaddition': ['kinbot', 'linear'],
                             ...
                             'intra_NO2_ONO_conversion': ['gcn', 'xtb_gsm', 'linear'],
                             ...
                             'intra_substitutionS_isomerization': ['gcn', 'xtb_gsm', 'linear'],
                             ...
                             'Retroene': ['kinbot'],
                             'Singlet_Carbene_Intra_Disproportionation': ['gcn', 'xtb_gsm', 'linear'],
                             }
