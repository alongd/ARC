...
class ARCReaction(object):
    ...
    Args:
        ...
        rmg_family_set (Union[List[str], str], optional): The RMG family set to which the reaction belongs
                                                          (corresponds to sets in db families recommended.py)
                                                          or an explicit names of families to consider
    ...
    Attributes:
        ...
        rmg_family_set (Union[List[str]]): The RMG family set or a list of specific families to consider.
    ...
    def __init__(self,
                 ...
                 rmg_family_set: Union[List[str]] = 'default',
        ...
        self.rmg_family_set = rmg_family_set
    ...
    def __str__(self) -> str:
        ...
        if self.family is not None:
            str_representation += f'family="{self.family}", '
    ...
    def as_dict(self,
        ...
        if 'rmg_family_set' in reaction_dict and reaction_dict['rmg_family_set'] != 'default':
            reaction_dict['rmg_family_set'] = self.rmg_family_set
        if report_family:
            if self.family is not None:
    ...
    def from_dict(self,
        ...
        self.rmg_family_set = reaction_dict['rmg_family_set'] if 'rmg_family_set' in reaction_dict else 'default'
    ...
    def determine_family(self,
        ...
        product_dicts = get_reaction_family_products(rxn=self,
                                                     rmg_family_set=self.rmg_family_set,
