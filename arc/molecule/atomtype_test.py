...
class TestAtomType(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.atomtype = mm.atomtype.ATOMTYPES['Cd']
    ...
    def test_output(self):
        ...
        """
        namespace = {}
        exec('atomtype = mm.atomtype.ATOMTYPES[{0!r}]'.format(
    ...
    def test_equivalent(self):
        ...
        """
        self.assertTrue(self.atomtype.equivalent(mm.atomtype.ATOMTYPES['Cd']))

    def test_is_specfic_case_of(self):
        """
        Test the AtomType.is_specific_case_of() method.
        """
        self.assertTrue(self.atomtype.is_specific_case_of(mm.atomtype.ATOMTYPES['C']))

    def test_set_actions(self):
        """
        Test the AtomType.set_actions() method.
        """
        other = mm.atomtype.AtomType('Test', generic=['R'], specific=[])
    ...
    def test_make_sample_molecule(self):
        ...
        """
        failed = []
        for name, atom_type in mm.atomtype.ATOMTYPES.items():
...
class TestGetAtomType(unittest.TestCase):
    ...
    def test_carbon_types(self):
        ...
        self.assertEqual(self.atom_type(self.mol29, 0), 'C2tc')
    ...
    def test_silicon_types(self):
        ...
        self.assertEqual(self.atom_type(self.mol4, 7), 'Sit')
